...
public final class ObjLoader {
    ...
    // Source markers
    fileprivate static let commentMarker = "#".first//.characters.first
    fileprivate static let vertexMarker = "v".first//.characters.first
    fileprivate static let normalMarker = "vn"
    fileprivate static let textureCoordMarker = "vt"
    fileprivate static let objectMarker = "o".first//.characters.first
    fileprivate static let groupMarker = "g".first//.characters.first
    fileprivate static let faceMarker = "f".first//.characters.first
